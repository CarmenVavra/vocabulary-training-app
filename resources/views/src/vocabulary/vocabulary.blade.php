      ...
      <table id="tblVocs" class="table table-striped table-dark table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <a href="{{ route('vocabulary.edit', [$vocabulary->id,$vocabulary->vocabularies[0]->id]) }}" data-toggle="modal" data-target="#overlay-edit"><button type="button" class="btn btn-info btn-sm btn-edit">
